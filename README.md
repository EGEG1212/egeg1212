...
🍰Keywords of interest🍟<br>Voice recognitio(음성인식) / Speech Synthesis(음성합성) / Chatbot(챗봇) / Algorithm(알고리즘) / AI(artificial intelligence) / Big Data(빅데이터) / Machine Learning(머신러닝) / FinTech(핀테크) / Block Chain(블록체인) / hash sha /encoding(암호화) / bitcoin(비트코인) / Cryptocurrency(암호화폐)
